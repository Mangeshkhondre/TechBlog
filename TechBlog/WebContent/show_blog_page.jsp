...
<!-- User Login Validation to check if user has logged in or not  -->
<%
...
<head>
	...
	<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v7.0" nonce="7CzTd6iw"></script>
</head>
<body>
	
	<!-- start of navbar -->

	<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #00b0ff;">
	  <a class="navbar-brand" href="index.jsp"><span class="fa fa-graduation-cap"></span> Tech Blog</a>
            ...
            <div class="row my-4">
                ...
                <div class="col-md-8 offset-md-2">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <img class="card-img-top my-2" src="blog_pics/<%= p.getpPic()%>" alt="alt ">
                       ...
                       <%--   <div class="card-footer bg-secondary">
                            ...
                            <a href="#!" onclick="doLike(<%= p.getPid()%>,<%= user.getId()%>)" class="btn btn-outline-dark btn-sm bg-light"> <i class="fa fa-thumbs-o-up"></i> <span class="like-counter"> <%= ld.countLikeOnPost(p.getPid())%> </span>  </a>
                            <a href="#!" class="btn btn-outline-dark btn-sm bg-light"> <i class="fa fa-commenting-o"></i> <span>20</span>  </a>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header text-center" >
	        <h5 class="modal-title" id="exampleModalLabel">TechBlog Profile Details</h5>
				   ...
				   <div id="profile-edit" style="display: none;">
                                ...
                                <form action="EditServlet" method="post" enctype="multipart/form-data">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>Gender :</td>
                                            <td> <input type="text" class="form-control" name="user_gender" value="<%= user.getGender().toUpperCase()%>" > </td>
                                        </tr>
                                        <tr>
                                            <td>New Profile:</td>
                                            <td>
